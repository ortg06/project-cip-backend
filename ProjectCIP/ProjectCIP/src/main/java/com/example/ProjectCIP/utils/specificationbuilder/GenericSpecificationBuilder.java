...
public class GenericSpecificationBuilder<E> {
    ...
    private GenericSpecificationBuilder<E> addCriteria(String key, CriteriaOperation operation) {
        filterCriteriaList.add(new FilterCriteria<>(key, operation, null, Void.class, activeConditionType));
        return this;
    }

    private GenericSpecificationBuilder<E> addCriteria(String key, CriteriaOperation operation, JoinType joinType) {
        filterCriteriaList.add(new FilterCriteria<>(key, operation, joinType, Void.class, activeConditionType));
        return this;
    }
    ...
    private <C extends Comparable<? super C>> GenericSpecificationBuilder<E> addComparableCriteria(String key, C value, CriteriaOperation operation,
        ...
        if (value != null) {
            filterCriteriaList.add(new ComparableFilterCriteria<>(key, value, operation, (Class<C>) value.getClass(), relationType, activeConditionType));
        }
        return this;
    }
    ...
    /**
     * Adds a new "not in" criteria to the filterCriteriaList
     * <blockquote><pre>
     *     GenericSpecificationBuilder.of(Person.class)
     *     	.notIn("name", name)
     *     	.build();
     ...
     * @return
     */
    public GenericSpecificationBuilder<E> notIn(String key, Object value) {
        return addCriteria(key, value, CriteriaOperation.NOT_IN, RelationType.NO_RELATION);
    }
    ...
    public GenericSpecificationBuilder<E> customFunction(String functionName, String[] fieldNames, String... params) {
        ...
        for (String fieldName : fieldNames) {
            ...
            final Specification<E> fieldSpecification = (root, query, criteriaBuilder) -> {
                ...
                final Expression<?>[] parametersExp = parameterExpressions.toArray(new Expression<?>[]{});
                final Expression<Boolean> sqlFunction = criteriaBuilder.function(functionName, Boolean.class, parametersExp);
